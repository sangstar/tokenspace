...
mod.add_function('Slice_Ptr_tui_Word_CTor', retval('int64_t'), [])
mod.add_function('Slice_Ptr_tui_Word_len', retval('int'), [param('int64_t', 'handle')])
mod.add_function('Slice_Ptr_tui_Word_elem', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'idx')])
mod.add_function('Slice_Ptr_tui_Word_subslice', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'st'), param('int', 'ed')])
mod.add_function('Slice_Ptr_tui_Word_set', None, [param('int64_t', 'handle'), param('int', 'idx'), param('int64_t', 'value')])
mod.add_function('Slice_Ptr_tui_Word_append', None, [param('int64_t', 'handle'), param('int64_t', 'value')])
mod.add_function('tui_ResultSet_CTor', retval('int64_t'), [])
mod.add_function('tui_ResultSet_WordOfInterest_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('tui_ResultSet_WordOfInterest_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('tui_ResultSet_VectorDim_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('tui_ResultSet_VectorDim_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('tui_ResultSet_SimilarWords_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('tui_ResultSet_SimilarWords_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
...
add_checked_function(mod, 'tui_ProvePassable', retval('int64_t'), [param('char*', 'centralWord'), param('int64_t', 'centralWordVec'), param('int64_t', 'closestWords'), param('int64_t', 'closestWordDistances'), param('int64_t', 'closestWordVectors')])
