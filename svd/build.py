...
add_checked_function(mod, 'svd_Compress', retval('int64_t'), [param('int64_t', 'stackedList'), param('int64_t', 'outputDim')])
add_checked_function(mod, 'svd_ToDense', retval('int64_t'), [param('int64_t', 'stackedList')])
