# python build stubs for package svd
...
add_checked_function(mod, 'svd_Compress', retval('int64_t'), [param('int64_t', 'List'), param('int64_t', 'r'), param('int64_t', 'c'), param('int64_t', 'outputDim')])
add_checked_function(mod, 'svd_DenseToArray', retval('int64_t'), [param('int64_t', 'm')])

mod.generate(open('svd.c', 'w'))
